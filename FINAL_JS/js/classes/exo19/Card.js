...
export default class Card extends CoopDom {
    ...
    render = () => {
        ...
        const article = this.createAddDomElt(
            "article",
            "",
            this.column.domElements.section_cards, { "class": "text-light bg-dark rounded p-4 mt-2 mb-2" }
        );
        ...
        const input_question = this.createAddDomElt(
            "input",
            "",
            form_edit, { "type": "text", "value": this.question, "class": "form-control" }
        );
        ...
        const input_answer = this.createAddDomElt(
            "input",
            "",
            form_edit, { "type": "text", "value": this.answer, "class": "form-control" }
        );
        const button_submit_edit = this.createAddDomElt(
            "input",
            "",
            form_edit, { "type": "submit", "value": "Modifier", "class": "btn btn-primary mt-3 mb-3" }
        );
        // on cache le formulaire
        ...
        const button_remove = this.createAddDomElt(
            "button",
            "Supprimer la carte",
            article, { "class": "btn btn-danger mr-2 mb-2 w-100" }
        );
        ...
        const button_edit = this.createAddDomElt(
            "button",
            "Modifier la carte",
            article, { "class": "btn btn-warning mr-2 w-100" }
        );
